...
const NotificationsPage = () => {
  ...
  if (isPending) return <div style={{ padding: "20px" }}>Loading notifications...</div>;
          ...
          {data.map((n) => (
            <Link 
              ...
              <div style={{ width: "40px", height: "40px", borderRadius: "50%", overflow: "hidden" }}>
                <Image path={n.sender.img || "/general/noAvatar.png"} w={40} h={40} />
              </div>

              <div style={{ flex: 1 }}>
                <p style={{ margin: 0 }}>
                  <strong>{n.sender.displayName}</strong> {n.type === "comment" ? "commented on your pin:" : "interacted with your pin:"}
                </p>
                <p style={{ margin: 0, color: "#555", fontSize: "14px" }}>"{n.text}"</p>
              </div>
